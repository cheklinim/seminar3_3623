...
Чтобы создать новое подключение к удаленному репозиторию нужно ввсети команду:

    git remote add <name> <url>

Чтобы изменить адрес репозитория нужно ввсети команду:

    git remote set-url <name> <url>

Чтобы отправить закоммиченные файлы в удаленный репозиторий нужно ввсети команду:
