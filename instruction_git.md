...
### Копирование удаленного репозитория
 ...
 Для получения копии существующего Git-репозитория (например, проекта, в разработке которого вы хотите участвовать) необходимо использовать команду:
...
Когда вы хотите поделиться своими наработками, вам необходимо отправить их в удалённый репозиторий, для этого введите команду:
