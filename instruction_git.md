...
Чтобы отправить запрос на вливание своих изменений в проект, пользователь дает команду:

    pull request

Шаги для создания запроса представленны ниже:

1. Делам fork понравившегося репозитория.

2. Клонируем свою версию репозитория (git clone), ту, которая появилась после fork.

3. Создаём новую ветку для внесения изменений. Именно в этой ветке фиксируются все изменения (с помощью git commit).
