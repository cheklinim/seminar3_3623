...
Это необходимо что бы на удаленном репозитории появилась новая информация в репозитории для дальнейшей работы остальных членов команды с актуальной информацией. Выполняется командой:
