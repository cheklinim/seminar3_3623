...
### Хранение удалённых репозиториев
...
### Как начать работать с удалённым репозиторием?

Для того что бы начать работать с sourse проектом необходимо сделать fork понравившегося репозтория, а затем появившеюся копию на ресурсе, скачать себе на локальное устройство клмандой

    git pull <сылка на репозитрий>

Сохранение происходит путём копирования (клонирования) командой

    git clone <ссылка репозитория>

Дальнейшая работа с репозиторием проходит как и всегда.
После проведённых изменений репозиторий необходимо при помощи команды
