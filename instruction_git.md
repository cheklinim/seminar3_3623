...
2. Копировать ссылку удаленного репозитория
3. В терминале Git на вашем ПК использовать команду:

    git clone <ссылка на удаленный репозиторий>

Данная команда копирует удаленный репозиторий, расположенный по ссылке в ваш локальный репозиторий.

## Pull request - запрос на интеграцию изменений.

После копирования чужого репозитория в наш локальный репозиторий можно вносить в него некие изменения, предлагать улучшения и тд.

### Порядок внесения изменений:
* Для работы с новым репозиторием необходимо выполнить команду:

        cd

    (Change Directory). Данная команда выполняет смену каталога и инициализировать работу с Git над новым репозиторием.
* Важно! Все вносимые изменения должны оформляться в новой, созданной вами, ветке.
* Все изменения необходимо закоммитить и применить команду: git push, после чего изменения окажутся в удаленном репозитории на GitHub. 

* Мы можем предложить автору изначалного репозитория ознакомится с нашими изменениями выполнив команду: 
