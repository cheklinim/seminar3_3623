...
__Для управления подключением удаленных репозиториев в Git предусмотрена целая группа команд __git remote__:__
...
__Клонирование удаленного репозитория:__
