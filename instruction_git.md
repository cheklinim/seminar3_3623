...
3. Создать локальный репозиторий (или использовать уже готовый)

4. "Подружить" ваш локальный репозиторий с удаленным (на GitHub),мозможно потребуется авторизация на GitHub.
