...
### Порядок действий с open source проектами
Вы всегда можете поработать с проектами на GitHub, которые находятся в открытом доступе.

И так как вы не имеете прав доступа, чтобы что-то менять в другом проекте, вы всегда можете скопировать этот проект, внести правки, а потом предложить создателю проекта ознакомиться с изменениями и принять их или отказаться.

В GitHub это реализованно через функцию:

    pull request

Обычно порядок действий с open source проектами выглядит так:

1. Fork интересующий вас проект на свой акк на GitHub
2. Git clone этот репозиторий на локальный ПК
3. Работа в проекте в отдельной ветке
4. Все изменения делать только в этой ветке
5. Git push все изменения на свой акк в GitHun
6. В окне GitHub отправляем проект с изменениями создателю по кнопке Pull request

После создатель проекта либо принимает правки, либо отказывается от них. В любой случае вы можете пообщаться с ним в окне чата на вкладе pull request.